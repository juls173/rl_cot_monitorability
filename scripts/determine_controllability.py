...
class ReadabilityDriftEvaluator:
    """Evaluate linguistic drift through readability scoring via Regex"""
    ...
    def plot_determine_score_comparison(self, all_model_results: Dict[str, Dict], 
        ...
        ax2.set_title("""Answer Correctness: Normal vs "Don't use 'determine'" Prompt""",
                      fontsize=15, fontweight='bold', pad=15)
        ax2.set_xticks(x)
...
def main():
    ...
    num_samples = min(1000, len(questions))
    ...
    # ---
    # *** END of Base Model Evaluation Block ***
    # ---
